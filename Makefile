...
HTTPS_GIT := github.com/mygithub/ravias132.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=ravias132 \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c ravias132 --local -f chains.yaml
endif
